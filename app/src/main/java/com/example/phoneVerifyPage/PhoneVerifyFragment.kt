package com.example.phoneVerifyPage
...
import com.example.phoneauthfirebasemvvm.databinding.FragmentPhoneVerifyBinding
 ...
 * Use the [PhoneVerifyFragment.newInstance] factory method to
...
class PhoneVerifyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentPhoneVerifyBinding.inflate(layoutInflater)
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        Navigation.findNavController(binding.root)
                            .navigate(R.id.action_phoneVerifyFragment_to_mainUserUIFragment)
